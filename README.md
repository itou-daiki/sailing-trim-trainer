...
- Vitest: 122テスト（420／470別の船体・リグ寸法、マスト後傾・テーパー・滑らかな帆走中ベンド、セール形状とマスト反力の双方向連成、軽風／張力不足／オーバーベンドのシワ判定、15課題の初期診断と完了可能性、三方向の同一3D面、見かけ風、優先順位、共有URL、極端設定を横断する形状／空力不変条件を含む）
