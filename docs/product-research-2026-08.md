...
[North Sails Japan 420 M-12 Tuning Guide](https://www.northsails.co.jp/wordpress/wp-content/uploads/2026/03/420-M12-Tuning-Guide_j.pdf)は、オーバーパワーでない限りブームを艇のセンターへ持ってくること、10ノット付近でメインシート張力が最大になること、オーバーパワーになりブームが常にセンターから外へ出てからカニンガムを使うことを示す。[North Sails 470 Tuning Guide](https://colorcode.northsails.com/sailing/wp-content/uploads/2017/05/470_tuning_guide_e01.pdf)のトリミング表は、微風で中心線から風下へブーム幅3〜4本、フルパワーで中心線、オーバーパワー後は風速とともに風下へ出す段階を示す。

旧モデルはTWA 45°で風速に関係なく約18°だったため、ブームエンドが420で約740 mmも風下へ出ていた。再校正後は中心線を0°として、TWA 45°で420は4 kt時3.2°、10〜12 kt時1.6°、18 kt時10.4°、470は同条件で4.8°、0.8°、8.8°とする。TWA 55°まではクローズ域としてこの風速応答を保ち、55〜90°で45°へ、90〜150°で78°へ連続的に開く。これはブライドル、波、乗員重量、モードによる実艇差を残す代表初期値であり、唯一の正解角ではない。
