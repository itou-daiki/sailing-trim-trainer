    ...
    <div className="app-shell" id="top">
      ...
      <main>
        ...
        <section className="model-note" aria-label="モデルについて">
          ...
          <p>
            ジブは固定ラフを軸に動き、ラフ・リーチ・フット三辺を維持します。上・中・下のピークは表示メッシュとは別に断面式から計算し、同じ3D点を三方向と断面寸法へ使います。後方はブーム口の真後ろに置いた透視カメラで、実視と3断面を同時表示します。メインのクリューは、規則寸法のブラックバンド前縁から表示値と同じ0–25 mmだけ前へ動きます。メイン基本角は艇速と真風から見かけ風を反復計算し、クラス別クローズ基準・迎角15°・シュラウド上限を連続接続します。速度は上・中・下の断面から揚力・抗力・前進力を積分した学習用の推定値で、実測ポーラやCFDではありません。艇バランスとセンターボードは常に最適と仮定します。
          </p>
        </section>
      ...
      <footer>
        <span>TRIM NOTE / TRAINING BUILD 0.14.0</span>
